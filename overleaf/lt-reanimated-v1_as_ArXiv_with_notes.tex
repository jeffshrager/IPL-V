%%% See notes indicated as comments %%%

%%% Dedicate to Richard Wexelblat

%%% Target is CACM Historical 

%%% Mention John Hessler's project at Johns Hopkins ... esp. as he did
%%% some prelim work on LT!

%%% J functions at machine level -- not "real machine"

%%% "Exactly as specifcied"???

%%% The "pleasing circulatir" and "ironic" footnotes are a bit much.

%%% "I can report ...." depersonalize!

%%% Dick's wonderful paper! (At beginning of history)

%%% Add SLIP where Lisp and IPL are mentioned RE list processing.

%%% There's a number disagreement someplace in a long sentence! :-)

%%% Fix dicussion of Lisp self moidifcation -- that's not really what
%%% it celebrated for -- macros -- more carefully.

%%% "Rule-based control system" ... control system?!
...
%%% Tone this down and clarify that Lisp is only macro'ing these days,
%%% not self-modifying. See Art's notes. Also, prob. not diss
%%% McCarthy, remove "genius" part.
...
%%% Awkward 7 are not ... (see Art's notes)
...
J-function descriptions were sometimes vague in subtle ways. This had
...
Sixty years later, with the same family of programs, I faced
...
%% methodological assumption --> a heuristic! :-)
...
\noindent The successful execution of more complex derivations such as
this one that use previously proved theorems provides a striking
demonstration of the Logic Theorist’s capacity for a primitive form of
machine learning; By treating previously proved theorems, such as
2.20, as established 'givens' for subsequent search paths, the system
effectively bootstraps its own knowledge base, mirroring the
cumulative nature of algebraic reasoning.
