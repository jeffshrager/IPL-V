...
is addressable by a symbol (it's name). A set of control cells
...
whatever is the indicated next cell. Elegantly, beacuse H1 is both
...
it does interrupt a search that is in progress.
